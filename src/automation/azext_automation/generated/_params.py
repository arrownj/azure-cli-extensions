...
from azext_automation.action import (
    AddPublishContentLinkContentHash,
    AddSku
)
...
def load_arguments(self, _):
    ...
    with self.argument_context('automation automation-account create') as c:
        c.argument('resource_group_name', resource_group_name_type)
        c.argument('automation_account_name', type=str, help='The name of the automation account.')
        c.argument('name', type=str, help='Gets or sets name of the resource.')
        c.argument('location', arg_type=get_location_type(self.cli_ctx),
                   validator=get_default_location_from_resource_group)
        c.argument('tags', tags_type)
        c.argument('sku', action=AddSku, nargs='*', help='Gets or sets account SKU.')
